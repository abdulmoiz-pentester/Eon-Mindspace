...
const Login = () => {
 ...
 const handleSSOLogin = () => {
  // Use backend URL (port 5000), not frontend (port 8080) only for dev environment we will chnage it for prod and will remoc=ve the button of dev login
  window.location.href = 'http://localhost:5000/auth/dev/login';
};
